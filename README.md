...
- For the visualisation of the diabetes prediction model, a web application has been developed using Python Flask for the backend, HTML and CSS for the frontend, and JavaScript (script.js) for interactivity.
...
## 9. References
- Dataset: [https://www.kaggle.com/datasets/tigganeha4/diabetes-dataset-2019](https://www.kaggle.com/datasets/tigganeha4/diabetes-dataset-2019)
